        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('career.index')}}">View all vacncy</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('career.create')}}">Creat Vacancy</a></li>
